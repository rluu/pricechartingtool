...
# Works well for wheat (H.Venus - H.Saturn) (short cycle):
# Col 24, Mod 15, Hit 0.

# Works well for wheat (H.Jupiter - H.Saturn + H.Venus) (intermediate cycle):
# Col 59, Mod 60, Hit 0.
...
#                            tzinfo=pytz.utc)
startDt = datetime.datetime(year=1970, month=6, day=1,
                            hour=0, minute=0, second=0,
                            tzinfo=pytz.utc)
