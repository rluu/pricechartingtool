...
#     addHorizontalLine()
#
#   Newly added (Wed Feb 24 20:49:41 EST 2016) and updated (Sat Sep  3 10:03:06 EDT 2016):
#
...
#
#  See also methods inside ephemeris_utils.EphemerisUtils.
#
##############################################################################
...
class PlanetaryCombinationsLibrary:
    ...
    def getTagNameForLongitudeAspect(\
        ...
        supplementary to EphemerisUtils.getLongitudeAspectTimestamps().
    ...
    def addGeoConjunctionsOfDirectRetrogradeMidpointsVerticalLines(\
        ...
        geoRetrogradeDirectTimestampsResultsList = \
            EphemerisUtils.\
            getGeoRetrogradeDirectTimestamps(startDt, endDt,
