...
#   PriceChartDocumentData object that are relevant to a DJIA
#   chart.
#
##############################################################################
...
startDt = datetime.datetime(year=1990, month=1, day=1,
                            ...
                            tzinfo=pytz.utc)
#endDt   = datetime.datetime(year=1938, month=1, day=1,
#                            hour=0, minute=0, second=0,
#                            tzinfo=pytz.utc)
...
def processPCDD(pcdd, tag):
    ...
    relevant to the DJIA chart.  The tag str used for the created
