...
30 phases of a G.Moon Tropical month.
...
This resulting ephemeris will have the following data:
  ...
  G.Moon/G.Sun
  G.Moon/G.Sun % 360
  G.Moon_Tropical_Month_Phase (Values in range: [1, 30])
...
# This should produce file: "moon_tropical_30_phases_ephemeris_nyc.csv".
#
