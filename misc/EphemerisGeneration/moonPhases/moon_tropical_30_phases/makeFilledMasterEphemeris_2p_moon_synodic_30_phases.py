...
#
#   This script will also calculate the Moon tropical month phases.
...
#
#      python3 makeFilledMasterEphemeris_2p_moon_tropical_30_phases.py
#
##############################################################################
...
# Input CSV file.  
inputFilename = "/home/rluu/programming/pricechartingtool/misc/EphemerisGeneration/moonPhases/moon_tropical_30_phases/sun_moon_node_ephemeris_nyc.csv"

# Ouptut CSV file.  
outputFilename = "/home/rluu/programming/pricechartingtool/misc/EphemerisGeneration/moonPhases/moon_tropical_30_phases/moon_tropical_30_phases_ephemeris_nyc.csv"
...
# G.Moon_Tropical_Month_Phase
columnName = "G.Moon_Tropical_Month_Phase"
headerLine += "," + columnName
log.info("Calculating data for column: {}".format(columnName))
