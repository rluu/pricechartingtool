...
28 phases of a G.Moon Synodic month.
...
This resulting ephemeris will have the following data:
  ...
  G.Moon/G.Sun
  G.Moon/G.Sun % 360
  G.Moon_Synodic_Month_Phase (Values in range: [1, 28])
...
# This should produce file: "moon_synodic_28_phases_ephemeris_nyc.csv".
#

python3 makeFilledMasterEphemeris_2p_moon_synodic_28_phases.py
