...
# threshold of 1 minute) of each of the 28 moon synodic month phases.
#
# Note: Normally there are 30 moon phases, but this script is to get
#       the timestamps as if there are 28 moon synodic phases.  So the
...
outputFilename = "/home/rluu/programming/pricechartingtool/misc/EphemerisGeneration/moonPhases/moon_synodic_28_phases/sun_moon_node_ephemeris_nyc.csv"
...
# calculations as if it has 28 phases.
