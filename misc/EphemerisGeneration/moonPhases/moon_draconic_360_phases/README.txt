...
360 Moon phases of a Draconic month.
...
This resulting ephemeris will have the following data:
  ...
  G.Moon/G.Sun
  G.Moon/G.Sun % 360
  G.Moon_Draconic_Month_Phase (Values in range: [1, 360])
...
# This should produce file: "moon_draconic_360_phases_ephemeris_nyc.csv".
#
