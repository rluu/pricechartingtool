...
#
#   This script will also calculate 360 Moon phases of a Draconic month.
#   The moon phases are values in the range: [1, 360].
#
# Usage:
#
...
#
#      python3 makeFilledMasterEphemeris_2p_moon_draconic_360_phases.py
#
##############################################################################
...
# Input CSV file.  
inputFilename = "/home/rluu/programming/pricechartingtool/misc/EphemerisGeneration/moonPhases/moon_draconic_360_phases/sun_moon_node_ephemeris_nyc.csv"

# Ouptut CSV file.  
outputFilename = "/home/rluu/programming/pricechartingtool/misc/EphemerisGeneration/moonPhases/moon_draconic_360_phases/moon_draconic_360_phases_ephemeris_nyc.csv"
...
def doMoonPhaseCalculationForColumn(listOfDataValues,
    ...
    for i in range(len(listOfDataValues)):
        ...
        # Number of degrees per G.Moon_Draconic_Month_Phase.
...
# G.Moon_Draconic_Month_Phase
columnName = "G.Moon_Draconic_Month_Phase"
headerLine += "," + columnName
log.info("Calculating data for column: {}".format(columnName))
planetColumn = len(headerLine.split(",")) - 2     # Previous column.
