...
#
#   This script will also calculate 30 Moon phases of a Draconic month.
...
# Ouptut CSV file.  
outputFilename = thisScriptDir + os.sep + "moon_draconic_new_and_full_phases_ephemeris_nyc.csv"
