...
# threshold of 1 minute) of the moon Synodic month phases:
# new and full moons only.
#
# Data included is:
#
#        - Geocentric
...
#                            hour=hourOfDay, minute=minuteOfHour,
#                            tzinfo=timezone)
endDt   = datetime.datetime(year=2019, month=12, day=31,
                            hour=hourOfDay, minute=minuteOfHour,
                            tzinfo=timezone)
...
# Moon Synodic month has 30 phases normally, but here we will only get
# the new and full moons.  Thus we will 2 as the number of Moon
# phases.
...
# Planet parameters.
planet1Tuple = ("Moon", "geocentric", "tropical")
planet2Tuple = ("Sun",  "geocentric", "tropical")
