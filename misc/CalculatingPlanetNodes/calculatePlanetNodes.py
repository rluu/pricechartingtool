...
# Description:
#
# This script calculates the location of heliocentric planet nodes.
# 
# We calculate these by observing the heliocentric longitude of each
# planet at the moment that it crosses the plane of the ecliptic.
...
#   1) Run the script:
#
#           python3 calculatePlanetNodes.py
#
        ...
        if prevLatitude != None and currLatitude != None and prevDt != None:
            ...
            if prevLatitude < 0.0 and currLatitude >= 0.0:
                ...
                while currErrorTd > maxErrorTd:
                    ...
                    testTropLongitude = pi.heliocentric['tropical']['longitude']
...
if __name__ == "__main__":
    ...
    for planetName in heliocentricPlanetNames:
        log.info("Obtaining planet node information for '{}' ...".\
                 format(planetName))
        results[planetName] = getHeliocentricPlanetNodeInfo(planetName)
    ...
    headerLine = \
        ...
        "HelioTropLongitude," + \
        "HelioSidLongitude," + \
        "PlanetNorthNode_HelioTropLongitude," + \
        "PlanetNorthNode_HelioSidLongitude,"
    ...
    for planetName in heliocentricPlanetNames:
        ...
        for tup in listOfTuplesForPlanet:
            ...
            if node == northStr:
                helioTropLongitudeOfNorthNode = helioTropLongitudeOfNode
            elif node == southStr:
                helioTropLongitudeOfNorthNode = \
                    Util.toNormalizedAngle(helioTropLongitudeOfNode + 180)
            else:
                log.error("Unknown node type.")
                shutdown(1)
            
            # Get the heliocentric sidereal longitude of the north
            # node of this planet.
