##############################################################################
The scripts in this directory create CSV files with information related to geocentric planetary direct and retrograde stations.
##############################################################################


Usage:

1) Open the script file 'calculatePlanetDirectAndRetrograde.py' and 
...
This should produce the following file:
    ...
    planetDirectAndRetrograde.csv

3) The above will produce the results sorted by planet combination.  
